// ════════════════════════════════════════════════════════════════════════════
// Delicious Sips Coffee Roasters — Manufacturing CRM
// ════════════════════════════════════════════════════════════════════════════
// PART 1 of 4 — Imports · Constants · Styles · Shared helpers · Print report
// (paste into App.jsx, replacing everything, then paste Parts 2, 3, 4 below this)

import { useState, useEffect, useRef, useCallback } from "react";
import { fetchOrders, fetchReceiving, fetchAdjustments, fetchCupping, insertOrder, updateOrder, insertReceiving, updateReceiving, insertAdjustment, insertCupping, updateCupping, subscribeAll } from "./db";
...
// Delicious Sips Coffee Roasters — Manufacturing CRM
// ════════════════════════════════════════════════════════════════════════════
// PART 2 of 4 — Receiving Log · Inventory Log
...
// Delicious Sips Coffee Roasters — Manufacturing CRM
// ════════════════════════════════════════════════════════════════════════════
// PART 3 of 4 — PO Importer · Production Orders · PO Detail Modal
...
// Delicious Sips Coffee Roasters — Manufacturing CRM
// ════════════════════════════════════════════════════════════════════════════
// PART 4 of 4 — Cupping Log · Root App (CoffeeCRM)
// (paste directly below Part 3 — this is the final piece)
